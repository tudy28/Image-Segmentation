...
from input_pipeline import data_input_fn
from estimator import SemsegEstimator
from data_viz import mask_to_rgb


def main():
    parser = argparse.ArgumentParser(description='train UNet for Semantic segmentation')
    parser.add_argument('--data-dir', '-d', type=str, default='D:/UBB/Data Mining/Image Segmentation/archive/tfrecords/',
